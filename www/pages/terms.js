  ...
  <Layout>
    <Grid item lg={6} md={8} xs={10} className={classes.root}>
      ...
      <StyledParagraph>
        ...
        the information you find on this website (Good Food Guide), is strictly
        at your own risk. Good Food Guide will not be liable for any losses
      ...
      <StyledParagraph>
        If you have any questions about these Terms, please contact us (Go to
        our github repo and raise an issue!). Thank You.!
      </StyledParagraph>
    </Grid>
  </Layout>
);
