    ...
    return (
      <Layout >
        <div className={classes.terms}>
          <Typography variant="h1" align="center" color="primary" className={classes.title}>Terms and Conditions ("Terms")</Typography>
          ...
          <Typography variant="h2" color="primary" className={classes.subtitle}>Disclaimers</Typography>

          <p className={classes.paragraph}>
            All the information on this website -
            https://good-food-guide.netlify.com/ - is published in good faith and
            for general information purpose only. Good Food Guide does not make
            ...
            this website (Good Food Guide), is strictly at your own risk. Good
            Food Guide will not be liable for any losses and/or damages in
          ...
          <Typography variant="h2" color="primary" className={classes.subtitle}>Accounts</Typography>
          ...
          <Typography variant="h2" color="primary" className={classes.subtitle}>Termination</Typography>
          ...
          <Typography variant="h2" color="primary" className={classes.subtitle}>Updates</Typography>
          ...
          <Typography variant="h2" color="primary" className={classes.subtitle}>Contact Us</Typography>

          <p className={classes.paragraph}>If you have any questions about these Terms, please contact us.</p>
        </div>
      </Layout>
    );
  }
